...
class CandyProblem {
    ...
    private:
        ...
        VVi choices_for_cost(int cost) const {
            ...
            choices_for_cost_it(cost,state,0,retval,1000000000);

            return retval;
        }
        
        void choices_for_cost_it(int cost, Vi state, int coin_id, VVi& retval,int best) const {
            ...
            for (int num = 0,lim=this_coin.count; num <= lim; ++num) {
                ...
                if (diff>=0) {
                    ...
                    choices_for_cost_it(cost - total, state, coin_id+1, retval, best);
                }
            }
